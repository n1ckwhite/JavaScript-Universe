...
Вот обновлённая версия задач с добавлением скрытых примеров решений. Решения можно раскрыть при необходимости.
...
Вывод: массив объектов, представляющих посты. Например:
