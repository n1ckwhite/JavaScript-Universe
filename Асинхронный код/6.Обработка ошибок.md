...
Вот переработанный список задач с примерами решений, которые можно скрывать или показывать при необходимости:
...
```javascript
// Консоль может вывести одно из двух в зависимости от результата:
